...
class A:
    ...
    def __init__(self, radius, func_x, func_y, origin=[0,0], points=[], bounds=[]):
        #True
        self.is_closed = True
        self.A_e = []
        self.A_i = []
        ...
        self.func_x = func_x
        self.func_y = func_y
        self.calc = winding_number.winder(self.func_x,self.func_y, self.radius, origin, points,bounds)
